...
SECRET_KEY = 'django-insecure-)2e-#&-a%i5p!3q2z19spml6^9@sh0k5p1(kn^5@p7z-sc%^xn'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('DATABASE_HOST'),    # Or the IP address where your PostgreSQL server is running
